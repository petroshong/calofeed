...
export const SearchModal: React.FC<SearchModalProps> = ({ onClose, onViewProfile, onSelectFood }) => {
  ...
  return (
    <div 
      className="fixed inset-0 bg-white z-50 flex flex-col mobile-text-size-adjust mobile-modal-overlay"
      onClick={onClose}
    >
      <div onClick={(e) => e.stopPropagation()}>
      {/* Header */}
      <div className="sticky top-0 bg-white border-b border-gray-200 p-4 safe-area-pt">
        {/* Mobile drag handle */}
        ...
        <div className="flex-1 relative">
          ...
          <input
            ...
            className="w-full pl-10 pr-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-green-500 focus:border-transparent mobile-form-input"
            autoFocus
          />
        </div>
        </div>
