...
import { Trophy, Flame, Target, User, Crown, Medal, Award } from 'lucide-react';
...
export const Leaderboard: React.FC = () => {
  ...
  return (
    <div className="max-w-4xl mx-auto pb-20 lg:pb-0">
      {/* Header */}
      <div className="bg-gradient-to-r from-yellow-400 to-orange-500 text-white p-6 lg:p-8 rounded-b-3xl lg:rounded-none">
