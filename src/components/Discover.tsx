...
const trendingHashtags = [
  ...
  { tag: 'salmon', count: 2156 },
  { tag: 'avocado', count: 1923 },
  { tag: 'chicken', count: 1876 },
  { tag: 'quinoa', count: 1654 },
  { tag: 'smoothie', count: 1543 },
  { tag: 'eggs', count: 1432 },
  { tag: 'keto', count: 1387 },
  { tag: 'plantbased', count: 1298 },
  { tag: 'pasta', count: 1234 },
  { tag: 'salad', count: 1187 },
  { tag: 'proteinpacked', count: 1156 },
  { tag: 'broccoli', count: 1098 },
  { tag: 'rice', count: 1045 },
  { tag: 'yogurt', count: 987 },
  { tag: 'berries', count: 934 },
  { tag: 'nuts', count: 876 },
  { tag: 'cheese', count: 823 },
  { tag: 'spinach', count: 789 },
  { tag: 'beef', count: 756 },
  { tag: 'turkey', count: 698 },
  { tag: 'bread', count: 645 },
  { tag: 'banana', count: 612 },
  { tag: 'tomatoes', count: 587 },
  { tag: 'carrots', count: 534 },
  { tag: 'almonds', count: 498 },
  { tag: 'apple', count: 467 },
  { tag: 'orange', count: 423 },
  { tag: 'grapes', count: 389 },
  { tag: 'pork', count: 356 },
  { tag: 'kale', count: 334 },
  { tag: 'walnuts', count: 312 },
  { tag: 'cashews', count: 289 },
  { tag: 'seeds', count: 267 },
  { tag: 'milk', count: 245 },
  { tag: 'peanuts', count: 223 },
  { tag: 'soup', count: 201 },
  { tag: 'stirfry', count: 189 },
  { tag: 'grilled', count: 167 },
  { tag: 'baked', count: 145 },
  { tag: 'roasted', count: 123 },
  { tag: 'steamed', count: 101 },
  { tag: 'italian', count: 98 },
  { tag: 'mexican', count: 87 },
  { tag: 'asian', count: 76 },
  { tag: 'mediterranean', count: 65 },
  { tag: 'thai', count: 54 },
  { tag: 'chinese', count: 43 },
  { tag: 'japanese', count: 32 },
  { tag: 'korean', count: 21 },
  { tag: 'indian', count: 19 },
  { tag: 'greek', count: 17 }
];
...
const trendingMeals: Meal[] = [
  {
    ...
    description: 'Viral salmon bowl that everyone is making! 🔥 #salmon #quinoa #avocado #mealprep #proteinpacked #seafood #omega3',
    calories: 520,
    protein: 42,
    carbs: 35,
    fat: 22,
    ...
    isLiked: false,
    isBookmarked: false,
    tags: ['salmon', 'quinoa', 'avocado', 'mealprep', 'proteinpacked', 'seafood', 'omega3'],
    visibility: 'public'
  },
  {
    id: '2',
    ...
    description: 'The Buddha bowl that broke the internet 🌱 #buddhabowl #chickpeas #quinoa #kale #tahini #plantbased #vegan #legumes',
    calories: 420,
    protein: 18,
    carbs: 52,
    fat: 16,
    ...
    isLiked: true,
    isBookmarked: true,
    tags: ['buddhabowl', 'chickpeas', 'quinoa', 'kale', 'tahini', 'plantbased', 'vegan', 'legumes'],
    visibility: 'public'
  }
];
...
export const Discover: React.FC<DiscoverProps> = ({ onHashtagClick }) => {
  ...
  return (
    <div className="w-full max-w-6xl mx-auto pb-20 lg:pb-0 px-4 lg:px-6">
      {/* Header */}
      <div className="bg-gradient-to-r from-pink-500 to-rose-500 text-white p-6 lg:p-8 rounded-b-3xl lg:rounded-xl lg:mt-6">
