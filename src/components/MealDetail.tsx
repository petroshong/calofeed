...
import { X, Heart, MessageCircle, Share, Bookmark, MoreHorizontal, MapPin, Clock, User, Flag, Copy } from 'lucide-react';
            ...
            <div className="p-6 border-b border-gray-200">
              ...
              {meal.tags && meal.tags.length > 0 && (
                <div className="flex flex-wrap gap-2 mb-4">
                  {meal.tags.map((tag) => (
                    <span key={tag} className="px-2 py-1 bg-blue-50 text-blue-700 text-sm rounded-full">
                      #{tag}
                    </span>
                  ))}
                </div>
